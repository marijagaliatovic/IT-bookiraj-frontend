...
const Apartment =  async ( { params }: { params: Params }) => {
  console.log("ID apartmana:", params.id);
  const apartment = await contentfulService.getAllPhotos(params.id);
    ...
    <>
      <div className="bg-white mb-20 pt-5 pb-10 mx-5 rounded-md mt-32 md:mx-auto w-1/2 px-10">
        <div className="mx-auto bg-white">
          <SlideShow images= {apartment[0].imagesCollection}/>
        </div>
        ...
        <h1 className="bg-white flex ml-10">
          {apartment[0].location} | Room | {apartment[0].priceNumber} per night
        </h1>
